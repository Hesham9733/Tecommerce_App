...
class FeedDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final prodAtt = _productsProvider.findById(productId);
    return Dialog(
                ...
                children: [
                  Flexible(
                    child: dialogContent(
                        ...
                        0,
                        () => {
                              _favsProvider.addOrRemoveFromFav(
                                  productId,
                                  prodAtt.title,
                                  prodAtt.imageUrl,
                                  prodAtt.price),
                  ...
                  Flexible(
                    child: dialogContent(context, 1, () {
                      Navigator.of(context)
                          .pushNamed('Product Details', arguments: productId)
                  ...
                  Flexible(
                    child: dialogContent(
                      context,
                      2,
                      _cartProvider.getCartItems.containsKey(productId)
                          ? () {
