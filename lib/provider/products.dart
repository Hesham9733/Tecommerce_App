...
class Products with ChangeNotifier {
      ...
      productsSnapshot.docs.forEach((element) {
        _productsList.insert(
            ...
            Product(
              ...
              isPopular: element.get('popularity'),
            ));
      });
    });
  }

  List<Product> findByCategory(String _categoryName) {
    List _categoryList = _productsList
        .where((element) => element.productCategoryName
            .toLowerCase()
            .contains(_categoryName.toLowerCase()))
        .toList();
    return _categoryList;
  }

  List<Product> findByBrand(String _brandName) {
    List _brandList = _productsList
        .where((element) =>
            element.brand.toLowerCase().contains(_brandName.toLowerCase()))
        .toList();
    return _brandList;
  }

  List<Product> get popularProducts {
    return _productsList.where((element) => element.isPopular).toList();
  }
  ...
  List<Product> searchQuery(String searchText) {
    List _searchList = _productsList
        .where((element) =>
